    ...
    <section className="bg-dark bg-[url('/img/twice_code2.png')] bg-[length:50%_1087px] bg-no-repeat bg-right 2xl:h-[1087px]">
      <div className="bg-dark/40 py-10 md:py-16 lg:py-24 2xl:pt-[127px] xl:pb-[119px] h-full">
        <div className="w-[85%] xl:w-3/4 mx-auto">
          <div className="max-w-[723px] text-white">
          ...
          <div className="sm:flex items-center justify-between mt-10 lg:mt-14 2xl:mt-[88px] xl:gap-5 2xl:gap-10">
            <div className="pt-5 md:pt-8 lg:pt-10 2xl:pt-[51px] pb-4 md:pb-6 lg:pb-[33px] px-5 sm:px-8 lg:px-10 xl:px-16 2xl:px-24 bg-white sm:w-[65%]  md:w-[67%] lg:w-[75%] xl:w-[75%] 2xl:w-[1075px]">
              ...
              <div className="pt-3 sm:pt-4 md:pt-5 2xl:pt-9 grid grid-cols-2 divide-x-2 divide-[#BCC0CB]">
                <div className="py-4 sm:py-5 md:py-8 lg:py-14 xl:py-20 font-poppins text-center">
                  <h1 className="transition duration-1000 ease-in-out text-2xl sm:text-3xl md:text-5xl lg:text-7xl xl:text-8xl 2xl:text-[120px] text-[#1D3061] 2xl:leading-[120px] font-bold">
                    32%
                  </h1>
                  <p className="text-sm sm:text-base lg:text-lg xl:text-xl 2xl:text-[25px]">
                    {" "}
                    web solutions development
                  </p>
                </div>
                <div className="py-4 sm:py-5 md:py-8 lg:py-14 xl:py-20 font-poppins text-center">
                  <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl xl:text-8xl 2xl:text-[120px] text-[#1D3061] 2xl:leading-[120px] font-bold">
                    56%
                  </h1>
                  <p className="text-sm sm:text-base lg:text-lg xl:text-xl 2xl:text-[25px]">
                    {" "}
